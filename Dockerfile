...
WORKDIR /app
COPY bridge.py config.py db.py events.py filters.py hermes_client.py incidents.py message_format.py notifications.py ntfy_publish.py query_parser.py raise_rules.py settings.py ui.py VERSION /app/
